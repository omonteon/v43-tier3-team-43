                ...
                {conversation.map((message) => {
                    {
                        if (message.sender == user.id) {
                            return <RightMessage message={message.body} sender={message.sender} readCount={users.length - 1 - message.readBy.length} />
                        } else {
                            return <LeftMessage message={message.body} sender={message.sender} readCount={users.length - 1 - message.readBy.length} />
                        }
                    }
                })
                }

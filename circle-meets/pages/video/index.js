    ...
    <main className="flex flex-col items-center justify-center min-h-screen bg-communixPurple bg-opacity-75">
      ...
      <div className="flex flex-col items-center mt-4">
        ...
        <div className="flex mt-4">
          <input
            type="text"
            className="px-4 py-2 text-communixPurple bg-communixWhite rounded-l-lg focus:outline-none focus:ring-2 focus:ring-communixPurple focus:ring-offset-2 w-64"
            readOnly
            value={callId}
          />
          <button
